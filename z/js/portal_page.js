...
function(require, staticurl, pfileurl) {
	var init = function() {
			...
			require(["/", portal_all], function(wx_share) {
				main();
				...
				if (scene_type_map[page_type]) {
					...
					var isNotUserShare = SOHUZ.page.user_id === "3032984";
					if (is_weixin && !isNotUserShare) {
						wx_share.init(s)
					}
				}
			}, function() {
...
}(require, SOHUZ.CONF.url_res, SOHUZ.CONF.url_pfile ? SOHUZ.CONF.url_pfile : "https://pfile.kuaizhan.com");